...
ggsave(
  plot = plt_top15
  , filename = glue('1.Similarities_Comparison_Bar1_{chr_user}_importance.png')
  , width = 16
  , height = 10
)
...
ggsave(
  plot = plt_top15.sub
  , filename = glue('2.Similarities_Comparison_Bar2_{chr_user}_importance.png')
  , width = 16
  , height = 10
)
...
ggsave(
  plot = plt_hist
  , filename = glue('3.Similarities_Comparison_Hist1_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  plot = plt_hist.sub
  , filename = glue('4.Similarities_Comparison_Hist2_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  plot = plt_heatmap
  , filename = glue('5.Similarities_Comparison_Heatmap1_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  ...
  , filename = glue('6.Similarities_Comparison_Heatmap2_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  plot = plt_heatmaps
  , filename = glue('7.Similarities_Comparison_Heatmap3_{chr_user}_importance.png')
  , width = 17
  , height = 8
)
...
ggsave(
  plot = plt_line
  , filename = glue('8.Similarities_Comparison_Lines1_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  plot = plt_line.sub
  , filename = glue('9.Similarities_Comparison_Lines2_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
...
ggsave(
  plot = plt_lines
  , filename = glue('10.Similarities_Comparison_Lines3_{chr_user}_importance.png')
  , width = 16
  , height = 8
)
