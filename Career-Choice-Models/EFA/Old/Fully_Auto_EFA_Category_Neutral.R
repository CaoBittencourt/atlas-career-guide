...
.dbl_cross_loading.threshold <- 0.20
...
# MODELS RELIABILITY ------------------------------------------------------
EFA_All$all.models.evaluation %>% view()
EFA_All$best.models.evaluation %>% view()

EFA_All$EFA.workflow$EFA.top.items$EFA.1Factor$reliability.evaluation %>% view()
EFA_All$EFA.workflow$EFA.top.items$EFA.2Factor$reliability.evaluation %>% view()
EFA_All$EFA.workflow$EFA.top.items$EFA.3Factor$reliability.evaluation %>% view()
EFA_All$EFA.workflow$EFA.top.items$EFA.4Factor$reliability.evaluation %>% view()

# TOP ITEMS ---------------------------------------------------------------
EFA_All$best.model$top.items %>% view()
EFA_All$EFA.workflow$top.items$EFA.2Factors %>% view()
EFA_All$EFA.workflow$top.items$EFA.3Factors %>% view()
EFA_All$EFA.workflow$top.items$EFA.4Factors %>% view()
