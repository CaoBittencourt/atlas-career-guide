...
In this example, the "severity" of the adjustment is entirely proportional to the similarity between occupations, and does not depend on arbitrarily set parameters. Additionaly, the more similarity approaches 1, the more interchangeability becomes linear.
