...
chr_bucket.render <- 's3://atlas-bubble-dev/'
...
fun_name.unique(chr_suffix = '.png') -> chr_file.name
...
fun_handler <- function(body, ...){  
  ...
  save_object('db/occupations.csv', file = '/tmp/occupations.csv', bucket = chr_bucket.data, region = 'us-east-2')
  save_object('db/career_finder_report.xlsx', file = '/tmp/career_finder_report.xlsx', bucket = chr_bucket.data, region = 'us-east-2')
  ...
  # --- S3 SOURCE (SETUP) ----------------------------------------------------------
  save_object('R/fun_kflex.R', file = '/tmp/fun_kflex.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/fun_matching.R', file = '/tmp/fun_matching.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/geom_dumbbell.R', file = '/tmp/geom_dumbbell.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/fun_plots.R', file = '/tmp/fun_plots.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/fun_scores.R', file = '/tmp/fun_scores.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/fun_texts.R', file = '/tmp/fun_texts.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/list_df_text.R', file = '/tmp/list_df_text.R', bucket = chr_bucket.fun, region = 'us-east-2')
  save_object('R/list_factors.R', file = '/tmp/list_factors.R', bucket = chr_bucket.fun, region = 'us-east-2')
  ...
  save_object('Rmd/matching_report.Rmd', file = '/tmp/matching_report.Rmd', bucket = chr_bucket.data, region = 'us-east-2')
  rmarkdown::render(
  ...
  put_object(outfile, object = chr_s3_object, bucket = chr_bucket.render, region = 'us-east-2')
