...
```{r, fig.width=4.8, fig.height=4.8, fig.align='center', fig.cap=list_plots.caption[[1]]}
plt_match.polar
```
...
```{r line.plot, fig.width=6.3, fig.height=2.5, fig.align='center', fig.cap=list_plots.caption[[2]]}
plt_line.rank
```
...
```{r distribution.plot, fig.width=6.3, fig.height=2.5, fig.align='center', fig.cap=list_plots.caption[[3]]}
plt_density
```
...
```{r best.plot, fig.width=6.3, fig.height=4.8, fig.align='center', fig.cap=list_plots.caption[[4]]}
...
```{r worst.plot,  fig.width=6.3, fig.height=4.8, fig.align='center', fig.cap=list_plots.caption[[5]]}
