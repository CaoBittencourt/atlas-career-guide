...
# dsds --------------------------------------------------------------------
for(user in c('Acilio', 'Cao', 'Gabriel', 'Martijn')){
  ...
  chr_text.broadness %>%
    recode(
      ...
      , 'somewhat normally distributed' = 'your professional profile is not too specialized nor is it too broad as well, and your range of either recommended or incompatible occupations will be restricted, as most of your compatibility scores concentrate in the middle of the distribution. In other words, you\'re unlikely to very good at many different careers paths, and also unlikely to very bad. But generally speaking, it is wiser to focus on the right end of the distribution, where you\'ll probably excel'
