...
install_github('CaoBittencourtFerreira/atlas.eqvl', force = T)
install_github('CaoBittencourtFerreira/atlas.match', force = T)
install_github('CaoBittencourtFerreira/atlas.intc', force = T)
install_github('CaoBittencourtFerreira/atlas.skew', force = T)
install_github('CaoBittencourtFerreira/atlas.kcoef', force = T)
