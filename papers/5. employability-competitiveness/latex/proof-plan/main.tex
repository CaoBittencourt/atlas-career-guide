...
\begin{gather}
    ...
    ,
\end{gather}
employers' optimal choice would be to save their resources and entirely shutdown the productive effort. Therefore,
\begin{gather}
    \lnot \
    \mho_q > 0
    \implies
...
Otherwise, rational employers would lay off excess workers to downscale the workforce from a suboptimal $w_q > 0$ to some $w_{q}^{*} \leq w_q$ to save resources. Thus, the current workforce, necessarily, has to be of the optimal
\begin{gather}
    \sum_{v=1}^{p}
    w_{q}^{v}
    =
