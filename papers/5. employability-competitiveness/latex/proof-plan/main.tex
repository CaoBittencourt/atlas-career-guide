...
We have just demonstrated that the maximum operational output in any labor market is exactly the number of employees in its workforce, or $w_q$.
...
Maximum Operational Output Lemma (MOOL)
    ...
    [Proof]
    [Let us begin with a binary setting.]
    \begin{align}
        \mho(\tilde{w}_{q}^{k})
        &=
        \min\left(
