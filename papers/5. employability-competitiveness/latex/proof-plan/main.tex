...
The maximum operational output of any labor market is exactly the number of employees in its workforce:
    ...
    Note, however, employers could also attempt to increase production beyond this level if they reduced the responsabilities of a particular job subtype by setting
    \begin{align}
    \ell_v < \ell_{v}^{*}
    \implies
        \left(
