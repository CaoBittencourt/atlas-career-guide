...
\begin{enumerate}
    ...
    Each of these job types is indispensable and equally contributes to occupation $q$'s operation, so that operational output is given by the Leontiev function:
    \begin{gather}
        \mho_{q} = 
        \min
        \left(
