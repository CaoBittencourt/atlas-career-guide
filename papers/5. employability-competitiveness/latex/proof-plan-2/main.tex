...
For example, an artist, an airline pilot and a surgeon all have to have manual dexterity as part of their skill set. Nevertheless, one's dexterity is combined with their creativity and applied to producing art, while the others' are combined with specific, technical, knowledge and applied, respectively, to maneuvering airbuses and performing surgery. And, for this reason, each of these's manual dexterity is not necessarily transferable to the other's activities: thus, indeed, to be talented with the scalpel does not mean one is any good with a paint brush; for the painter's ability is not really ``manual dexterity'' itself, but ``artistic-manual-dexterity'', whereas a surgeon's is ``surgical-manual-dexterity'' (here the hyphens emphasize occupational atomicity, or indivisibility, as the same compentecy, combined to another set of skills yields very different results).
% For example, an artist, an airline pilot and a surgeon all have to have manual dexterity as part of their skill set. Nevertheless, one's dexterity is combined with their creativity and applied to producing art, while the others' are combined with specific, technical, knowledge and applied, respectively, to maneuvering airbuses and performing surgery. And, for this reason, each of these's manual dexterity is not very much transferable to the other's activities: indeed, a surgeon being talented with the scalpel does not mean they are any good with a paint brush.

% For example, an artist, an airline pilot and a surgeon all have to have manual dexterity as part of their skill set. Nevertheless, one's dexterity is combined with their creativity and applied to producing art, while the others' are combined with specific, technical, knowledge and applied, respectively, to maneuvering airbuses and the scalpel. And, because of this, their manual dexterity is not very much transferable to 
