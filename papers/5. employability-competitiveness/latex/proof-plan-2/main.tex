...
\begin{axiom}[Employer Rationality Axiom, ERA]
    ...
    they will always choose to implement the production strategy, ``PS'', that maximizes operational output, given the, available talent, or expected productivity in the workforce:
    \begin{gather}
        \max_{
            \text{PS},
            \boldsymbol{w_q},
