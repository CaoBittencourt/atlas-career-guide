...
\begin{axiom}[Employer Rationality Axiom, ERA]
    \label{era}
    Employers are rational and only hire employees to work on tasks for which they are qualified. Additionaly, if labor stratification is allowed, rational employers will split job posts and outsource activities if they expect workers cannot accomplish the whole operation.
