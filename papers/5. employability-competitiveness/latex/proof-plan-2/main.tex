...
\begin{lemma}[Minimum Productivity Lemma, MPL]
    ...
    \begin{proof}
        ...
        And, to summarize, we could also write:
        \begin{gather}
...
\begin{lemma}[Productivity Sufficiency Lemma, PSL]
    ...
    \begin{proof}
        ...
        At last, from all valid production strategies we have considered, maximum labor stratification is that which has the lowest barrier of entry, and so minimizes productivity requirements. Indeed, if production is organized independently,
        \begin{gather}
        \mho_q = w_q
        \iff
        \tilde{T}_{q}^{v}
