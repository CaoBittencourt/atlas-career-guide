...
\begin{lemma}[Infinite Stratification Lemma, ISL]
    ...
    \begin{gather}
        ...
        ,
        \end{gather}
        then employers' optimal strategy is to infinitely stratify positions to infinitesimal tasks,
        \begin{gather}
            \lim_{p \rightarrow \infty}{
                \tilde{w}_{q}^{v}
            }
...
\begin{lemma}[Equivalent Stratification Lemma, ESL]
...
\begin{lemma}[Maximum-Monotonic Labor Stratification Lemma, MLSL]
    ...
    \begin{proof}
        ...
        Therefore, employing potentially underqualified workers to output the entire responsability spectrum $l \in [0,1]$ independently can only be as productive as the labor stratification strategy, but never more than it. Indepedent production, then, is a suboptimal strategy when employers expect there to be skill differences in the workforce. And the same logic applies to less than maximally-stratified arrangements.
