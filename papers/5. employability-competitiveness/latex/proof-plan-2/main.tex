...
\end{axiom}
% endregion
And, with this, we can define productivity in a more convenient way.
% region: productivity distribution 
\label{def_prod}
\begin{definition}[Productivity]
    A person $k$'s productivity in any set of tasks is
    \begin{gather}
        \tilde{T}_{i}^{k}
        :=
        \int_{0}^{1}
        ...
        ,
    \end{gather}
    or the percentage of tasks for which they are sufficiently qualified.
\end{definition}
