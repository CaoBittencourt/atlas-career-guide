...
Note we, here, have assumed production is profitable to begin with, such that revenue is at least equal to the sum of wages paid,
    \begin{gather}
        ...
        ,
    \end{gather}
plus any additional operational costs; otherwise, rational employers' would not attempt to maximize operational output (as in Axiom \ref{era}) and, indeed, the labor market would not exist at all (cf. ``Productivity Sufficiency Lemma'' below).
