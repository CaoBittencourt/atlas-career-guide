...
\begin{axiom}[Occupational Complexity Axiom]
    ...
    \begin{subaxiom}[Moderate Occupational Complexity Axiom, MOCA] With moderate occupational complexity, we assume production can be split into $p$ positions, or job subtypes, each responsible for their own subset of tasks with increasing difficulty levels.
