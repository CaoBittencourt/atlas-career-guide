...
\begin{lemma}[General Stratification Lemma, GSL]
    ...
    \begin{proof}
        ...
        Thus, for any $p_q \in \{1, \dots, w_q\}$, a rational employer's optimization problem is just selecting the $\boldsymbol{w_q}$ vector of employment levels that maximizes the expected aggregate operational output, given the workforce's unknown productivity:
        \begin{align}
            \max_{\boldsymbol{w_q}}
            \
            &
