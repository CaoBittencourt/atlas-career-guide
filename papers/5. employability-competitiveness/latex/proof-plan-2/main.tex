...
But, because of this, if $p$ can be greater than $w_q$, then the optimal production strategy would, logically, be to offer as many types of jobs as possible, even infinitely many.
