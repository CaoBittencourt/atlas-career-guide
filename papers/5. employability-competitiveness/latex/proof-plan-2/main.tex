...
\begin{lemma}[Minimum Productivity Lemma, MPL]
    ...
    \begin{proof}
        ...
        It is clear in $\boldsymbol{\tilde{T}_q}$ elements are weakly decreasing on their row number (i.e. those higher up in the matrix are greater or equal to those below them), as
        \begin{alignat}{2}
            \lambda_{1}^{q}
            &< \dots
            < \tilde{T}_{q}^{\text{Ir}}
            ...
            ,
        \end{alignat}
        and similarly for every other row. So, we may generalize this as follows: 
    \end{proof}
\end{lemma}
% endregion
