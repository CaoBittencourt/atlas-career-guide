...
\begin{gather}
    ...
    % \boldsymbol{â_k} = \frac{\boldsymbol{a_k}}{\max{\boldsymbol{a_k}}}\\
    % \gamma_{k} = \text{sq}\left(\frac{\boldsymbol{a_k}}{\max_i{a_{i}^{k}}}\right)\\
    % \gamma_{k} = \text{sq}\left(\frac{\boldsymbol{a_k}}{\max{\boldsymbol{a_k}}}\right)\\
    % c_{k} = 
