...
careerGrid.expected |>
  ...
  gr$set.edge.attribute(
    "weight",
    value = careerGrid.expected$cost.expected
  ) |>
  gr$set.edge.attribute(
    "cost",
    value = careerGrid.expected$cost.expected
  ...
  gr$set.edge.attribute(
    "x.from",
    value = careerGrid.expected$x.expected
  ) |>
  gr$set.edge.attribute(
    "x.to",
    value = careerGrid.expected$x.expected.to
  ) |>
  gr$set.edge.attribute(
    "t.from",
    value = careerGrid.expected$t.expected
  ) |>
  gr$set.edge.attribute(
    "t.to",
    value = careerGrid.expected$t.expected.to
  ) |>
  gr$set.edge.attribute(
    "table.id",
