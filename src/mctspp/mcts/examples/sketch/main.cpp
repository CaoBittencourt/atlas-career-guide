...
int main() {
  // This is just to test the example, not ideally what one should be doing...
  // TODO
  bool done;
  char winner;
  ...
  do {
    agent.feedback();
    // TODO: This way we don't check if the enemy move ends the game but it's
    // our responsibility to check that, not the tree's...
    agent.genmove(
        enemy_move);  // Note: we ignore the move because the MCTS tree has
                      // played it as well and we can get it from there.
